      ...
      <div class="card">
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
              <div
                class="d-sm-flex align-items-baseline report-summary-header"
              >
    ...
    <div class="col-12 stretch-card grid-margin">
      <div class="card card-secondary">
        <span class="card-body d-lg-flex align-items-center">
          <p class="mb-lg-0 text-capitalize">
            welcome : {{ Auth::guard('admin')->user()->name }}
          </p>
          <a
            href=""
            target="_blank"
            class="btn btn-warning purchase-button btn-sm my-1 my-sm-0 ml-auto"
            >Check Latest Activities</a
          >
    ...
    <div class="col-md-4 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          <div
            class="wrapper mt-4 d-flex flex-wrap align-items-cente"
          >
            <div class="d-flex">
    ...
    <div class="col-md-8 grid-margin stretch-card">
      <div class="card">
        <div class="card-body performane-indicator-card">
          <div class="d-sm-flex">
            <h4 class="card-title flex-shrink-1">
          ...
          <div class="d-sm-flex flex-wrap">
            <div class="d-flex align-items-center">
              ...
              <p class="mb-0 ml-2 text-muted font-weight-semibold">
                Complaints (2098)
              </p>
            </div>
            <div class="d-flex align-items-center">
      ...
      <div class="card">
        <div class="card-header d-block d-md-flex">
          ...
          <p class="ml-auto mb-0">
            How are your active users trending overtime?<i
              class="icon-bulb"
            ></i>
          </p>
        </div>
        <div
          class="d-md-flex row m-0 quick-action-btns"
          role="group"
        ...
        <div class="card-body">
          <div class="row income-expense-summary-chart-text">
            <div class="col-xl-4">
              ...
              <p class="small text-muted">
                A comparison of people who mark themselves of their
                ineterest from the date range given above. Learn more.
              </p>
            </div>
            <div class="col-md-3 col-xl-2">
              <p class="income-expense-summary-chart-legend">
                <span style="border-color: #6469df"></span> Total
                Income
              </p>
              <h3>$ 1,766.00</h3>
            </div>
            <div class="col-md-3 col-xl-2">
              <p class="income-expense-summary-chart-legend">
                <span style="border-color: #37ca32"></span> Total
                Expense
              </p>
              <h3>$ 5,698.30</h3>
            </div>
            <div class="col-md-6 col-xl-4 d-flex align-items-center">
              ...
              >
                <div class="inpu-group-prepend input-group-text">
          ...
          <div class="row income-expense-summary-chart mt-3">
            <div class="col-md-12">
              <div
                class="ct-chart"
                id="income-expense-summary-chart"
              ></div>
            </div>
          </div>
        </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-sm-flex align-items-center mb-4">
            ...
            <a href="#" class="text-dark ml-auto mb-3 mb-sm-0">
              View all Products</a
            >
          </div>
              ...
              <tbody>
                <tr>
                  <td>
                    <img
                      ...
                      src="{{ asset('assets/admin/images/faces/face1.jpg') }}"
                      alt="profile image"
                    />
                    Katie Holmes
                  </td>
                  ...
                  <td>
                    <img
                      src="{{ asset('assets/admin/images/dashboard/alipay.png') }}"
                      alt="alipay"
                      class="gateway-icon mr-2"
                    />
                    alipay
                  </td>
                  <td>04 Jun 2019</td>
                ...
                <tr>
                  <td>
                    <img
                      class="img-sm rounded-circle"
                      src="{{ asset('assets/admin/images/faces/face2.jpg') }}"
                      alt="profile image"
                    />
                    Minnie Copeland
                  </td>
                  ...
                  <td>
                    <img
                      src="{{ asset('assets/admin/images/dashboard/paypal.png') }}"
                      alt="alipay"
                      class="gateway-icon mr-2"
                    />
                    Paypal
                ...
                <tr>
                  <td>
                    <img
                      class="img-sm rounded-circle"
                      src="{{ asset('assets/admin/images/faces/face3.jpg') }}"
                      alt="profile image"
                    />
                    Rodney Sims
                  </td>
                ...
                <tr>
                  <td>
                    <img
                      class="img-sm rounded-circle"
                      src="{{ asset('assets/admin/images/faces/face4.jpg') }}"
                      alt="profile image"
                    />
                    Carolyn Barker
                  </td>
