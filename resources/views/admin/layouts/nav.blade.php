       ...
       >
         ...
         <a class="dropdown-item preview-item">
           <div class="preview-thumbnail">
             <img
               src="{{ asset('assets/admin/images/faces/face10.jpg') }}"
               alt="image"
         ...
         <a class="dropdown-item preview-item">
           <div class="preview-thumbnail">
             <img
               src="{{ asset('assets/admin/images/faces/face12.jpg') }}"
               alt="image"
               class="img-sm profile-pic"
             />
           </div>
     ...
     <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
       ...
       >
         <img
           ...
           src="{{ asset('assets/admin/images/faces/face23.jpg') }}"
           alt="Profile image"
         />
         <span class="font-weight-normal text-capitalize">{{ Auth::guard('admin')->user()->name }}</span></a
       >
       <div
       ...
       >
         <div class="dropdown-header text-center">
           <img
             ...
             alt="Profile image"
           />
           <p class="mb-1 mt-3 text-capitalize">{{ Auth::guard('admin')->user()->name }}</p>
