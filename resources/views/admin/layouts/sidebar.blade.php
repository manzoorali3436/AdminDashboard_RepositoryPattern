<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      <li class="nav-item nav-profile">
        <a href="#" class="nav-link">
          ...
          <div class="text-wrapper">
            <p class="profile-name text-capitalize">{{ Auth::guard('admin')->user()->name }}</p>
      ...
      <li class="nav-item nav-category">
        <span class="nav-link">Admin Data</span>
      </li>
      <li class="nav-item">
        <a
          class="nav-link"
      ...
      <li class="nav-item">
        <a class="nav-link" href="pages/tables/basic-table.html">
          <span class="menu-title">User Quries</span>
      ...
      <li class="nav-item">
        <a
          ...
          aria-controls="auth"
        >
          <span class="menu-title">Book Store Setting</span>
